...
export const BudgetsLayout = () => {
  ...
  return (
    <div className="mx-auto max-w-6xl p-8 pb-28 md:pb-8">
      <div className="mb-8">
        <h1 className="mb-6 text-4xl font-black text-shadow-glow">💰 Budgets</h1>

        <div className="glass-dark fixed bottom-4 left-4 right-4 z-40 flex gap-2 rounded-xl p-2 md:static md:inline-flex md:w-auto">
          <NavLink to="/budgets" end className={linkClass}>
            Budgets
          </NavLink>
          <NavLink to="/budgets/recurring" className={linkClass}>
            Recurring
          </NavLink>
        </div>
      </div>
